...
public class DialogueManagerAnton : MonoBehaviour
{
    ...
    [SerializeField] private int soundFrequency = 2; //Plays audio every 2 chars
    [SerializeField] private float textSpeed = 0.015f;
    ...
    //                     textAudioSource.pitch = Random.Range(0.95f, 1.05f);
    //                     textAudioSource.PlayOneShot(clip, 0.5f);
    //                 }
    //             }
    //         }
